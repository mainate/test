...
#define FIFONAME        "/tmp/indiFIFOw"
#define FIFOCOMMAND     "cat < /tmp/indiFIFOw"
...
#define SLEEPTIME   30000   // Waiting time in loops (for usleep)
...
/***********************************************************************************
*   Child Class maintextWindow
***********************************************************************************/
/*class maintextWindow : virtual public textWindow
{
public:
    maintextWindow(int _l, int _c, int _y, int _x, char* _textTitle, void* (_ptrFuncSystem(void*))) : objWindow(_l, _c, _y, _x, _ptrFuncSystem), textWindow(_l, _c, _y, _x, _textTitle, NULL){};
    virtual ~maintextWindow() {};
//    virtual void startThread();
//    virtual void stopThread();
};*/
